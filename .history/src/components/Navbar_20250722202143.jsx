...
const Navbar = ({ onToggleEdit, onToggleAddStock, editMode, addStockMode ,onToggleRefundMode, isRefundMode
}) => {
  return (
    <nav className='navbar navbar-expand-lg navbar-dark bg-dark'>
      ...
      <div className="ms-auto d-flex align-items-center gap-3">
        <button
          className={`btn ${isRefundMode ? 'btn-danger' : 'btn-outline-warning'}`}
