...
const ProductList = ({ editMode, addStockMode }) => {
  // ...use editMode and addStockMode as before
  const [products, setProducts] = useState([])
  // const [editMode, setEditMode] = useState(false)
  const [addStockMode, setAddStockMode] = useState(false) // 🔥 NEW
      ...
      <div className='d-flex gap-3 mb-4'>
        <button
          ...
          onClick={() => {
            ...
            if (addStockMode) setAddStockMode(false) // prevent both modes together
          }}
        >
        ...
        <button
          ...
          onClick={() => {
            ...
            if (editMode) setEditMode(false) // prevent both modes together
          }}
        >
